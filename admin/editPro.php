...
<table width="70%"  border="1" cellpadding="5" cellspacing="0" bgcolor="#cccccc">
		...
		<select name="cId">
			<?php foreach($rows as $row):?>
				<option value="<?php echo $row['id'];?>"<?php echo $row['id'] 
					== $proInfo['cId']? "selected='selected'" : null;?>>
	...
	<tr>
		<td align="right">商品北极熊价</td>
		<td><input type="text" name="pPrice"  value="<?php echo $proInfo['pPrice'];?>"/></td>
	</tr>
	<tr>
		<td align="right">商品描述</td>
		<td>
			<textarea name="pDesc" id="editor_id" value="<?php echo $proInfo['pDesc'];?>"
