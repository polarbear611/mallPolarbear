...
//得到数据库中所有商品
$sql="select p.id,p.pName,p.pSn,p.pNum,p.mPrice,p.pPrice,p.pDesc,p.pubTime,p.isShow,p.isHot,c.cName from polarbear_pro as p join polarbear_cate c on p.cId=c.id {$where}  ";
...
$sql="select p.id,p.pName,p.pSn,p.pNum,p.mPrice,p.pPrice,p.pDesc,p.pubTime,p.isShow,p.isHot,c.cName from polarbear_pro as p join polarbear_cate c on p.cId=c.id {$where} {$orderBy} limit {$offset},{$pageSize}";
$rows=fetchAll($sql);

echo $order . "<br/>" . $keywords . "<br/>" . $page . "<br/>";
?>
<!doctype html>
<html>
<head>
                            ...
                            <tr>
                                ...
                                <td align="center">
					                        	...
					                        	<table class="table" cellspacing="0" cellpadding="0">
					                        		...
					                        		<tr>
					                        			<td  width="20%"  align="right">北极熊价格</td>
